...
const dict = {
  ...
  registerTitle: { ru: "Давай знакомиться!", kk: "Танысайық!", en: "Let's get to know you!" },
  registerHello: {
    ru: "Привет! Я Qorgau. Как тебя зовут?",
    kk: "Сәлем! Мен Qorgau. Атың кім?",
    en: "Hi! I'm Qorgau. What's your name?",
  },
  yourName: { ru: "Твоё имя", kk: "Сенің атың", en: "Your name" },
  namePlaceholder: { ru: "Например, Алина", kk: "Мысалы, Алина", en: "For example, Alina" },
  ...
  lockedLesson: { ru: "Пройди предыдущий урок", kk: "Алдыңғы сабақтан өт", en: "Finish the previous lesson" },
  finalTest: { ru: "Финальное испытание", kk: "Финалдық сынақ", en: "Final challenge" },
  finalUnlocked: {
    ru: "Все 14 уроков пройдены — открыто финальное испытание!",
    kk: "14 сабақ өтілді — финалдық сынақ ашылды!",
    en: "All 14 lessons done — the final challenge is unlocked!",
  },
  courseDone: {
    ru: "Курс безопасности завершён! Ты настоящий герой Qorgau 🏆",
    kk: "Қауіпсіздік курсы аяқталды! Сен нағыз Qorgau батырысың 🏆",
    en: "Safety course complete! You're a true Qorgau hero 🏆",
  },
  finalReward: { ru: "Финальная награда", kk: "Финалдық сыйлық", en: "Final reward" },
