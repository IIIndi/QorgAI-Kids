...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "QorgAI Kids — уроки безопасности для детей" },
      {
        name: "description",
        content:
          "Интерактивные уроки онлайн- и жизненной безопасности для детей 8–11 лет с котёнком Qorgau. Русский, казахский, английский.",
      },
      { name: "author", content: "QorgAI Kids" },
